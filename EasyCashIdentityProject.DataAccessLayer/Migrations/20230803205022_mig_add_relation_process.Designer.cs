...
namespace EasyCashIdentityProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20230803205022_mig_add_relation_process")]
    partial class mig_add_relation_process
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyCashIdentityProject.EntityLayer.Concrete.CustomerAccountProcess", b =>
                {
                    b.HasOne("EasyCashIdentityProject.EntityLayer.Concrete.CustomerAccount", "CreditingCustomer")
                        .WithMany("ReceivedProcesses")
                        .HasForeignKey("CreditorID");

                    b.HasOne("EasyCashIdentityProject.EntityLayer.Concrete.CustomerAccount", "DebitingCustomer")
                        .WithMany("InitiatedProcesses")
                        .HasForeignKey("DebitorID");

                    b.Navigation("CreditingCustomer");

                    b.Navigation("DebitingCustomer");
                });
            ...
            modelBuilder.Entity("EasyCashIdentityProject.EntityLayer.Concrete.CustomerAccount", b =>
                {
                    ...
                    b.Navigation("ReceivedProcesses");
                });
